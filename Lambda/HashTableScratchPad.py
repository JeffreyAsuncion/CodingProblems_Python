class SimpleHashTable:
    ...
    def djb2_hash(self, key):
        ...
        for byte in key_bytes:
            # TO HELP AVOID COLLISIONS - SHIFTING AND MASKING
    ...
    def basic_hash(self, key):
        # take in some string/key
        # turn the string in to bytes
        str_bytes = key.encode() # split up into array of bytes
